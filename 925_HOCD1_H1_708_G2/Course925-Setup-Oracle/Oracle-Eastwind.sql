...
-- Must be run from a user who has the 
-- CREATE TABLE system privilege
-- BEWARE: Tables are dropped first, for easy recreation
-- Do NOT run this script from a user who owns 
-- important tables with same names
drop table reservations;
drop table conferencerooms;
drop TABLE OrderDetails;
drop TABLE Orders;
drop TABLE SalaryHistories;
...
CREATE TABLE Employees (
	...
	ReportsTo int NULL ,
	CurrentSalary	number(5) not null,
	Commission	number(5) null,
	DivisionID	numeric(5) null,
	DepartmentID	numeric(5) null,
...
ALTER TABLE Employees
	...
	FOREIGN KEY (DivisionID, DepartmentID)
	REFERENCES Departments(DivisionID, DepartmentID)
...
/
 CREATE  INDEX EmpPostalCode ON Employees(PostalCode)
/
 CREATE INDEX Salary ON Employees(CurrentSalary)
/
...
(EmployeeID	int	not null,
 ...
 EndDate	date null)
/
ALTER TABLE SalaryHistories
 ADD Constraint PK_SalaryHistory
...
/
 CREATE  INDEX CustCity ON Customers(City)
/
-- CREATE  INDEX CustCompanyName ON Customers(CompanyName);

 CREATE  INDEX CustPostalCode ON Customers(PostalCode)
/
...
/
 CREATE  INDEX SuppCompanyName ON Suppliers(CompanyName)
/
 CREATE  INDEX SuppPostalCode ON Suppliers(PostalCode)
/
CREATE TABLE Orders (
...
/
 CREATE  INDEX OrdEmployeeID ON Orders(EmployeeID)
/
...
/
 create index OrdCustomerID on Orders(CustomerID)
/
...
/
 CREATE  INDEX ProdCategoryID ON Products(CategoryID)
/
 CREATE  INDEX ProductName ON Products(ProductName)
/
 CREATE  INDEX ProdSupplierID ON Products(SupplierID)
/
...
/
 CREATE  INDEX DetailOrderID ON OrderDetails(OrderID)
/
 CREATE  INDEX DetailProductID ON OrderDetails(ProductID)
...
insert into Customers VALUES('QUEDE','Queen Delicia','Bernardo Batista','Accounting Manager','Rua da Panificadora, 12','Rio de Janeiro','RJ','02389-673','Brazil','(21) 555-4252','(21) 555-4545');
insert into Customers VALUES('QUEEN','Queen Delicia','Lúcia Carvalho','Marketing Assistant','Alameda dos Canàrios, 891','Sao Paulo','SP','05487-020','Brazil','(11) 555-1189',NULL);
...
VALUES
('NOMEI','Norske Meierier','Beate Vileid','Marketing Manager'
,'Hatlevegen 5','Sandvika',NULL
,'1320','Norway','(0)2-953010',NULL)
/
insert into  Customers 
(CustomerID,CompanyName,ContactName,ContactTitle
,Address,City,Region
,PostalCode,Country,Phone,Fax)
VALUES
('LYBYS','Lyngbysild','Niels Petersen','Sales Manager'
,'Lyngbysild Fiskebakken 10','Lyngby',NULL
,'2800','Denmark','43844108','43844115')
/
commit;

insert into Divisions(DivisionID,DivisionName)
VALUES(1,'America');
insert into Divisions(DivisionID,DivisionName)
VALUES(2,'Europe');
insert into Divisions(DivisionID,DivisionName)
...
insert into Departments(DivisionID,DepartmentID,DepartmentName)
VALUES(1,100,'Accounting');
insert into Departments(DivisionID,DepartmentID,DepartmentName)
VALUES(1,200,'Sales');
insert into Departments(DivisionID,DepartmentID,DepartmentName)
VALUES(1,300,'Research');
insert into Departments(DivisionID,DepartmentID,DepartmentName)
VALUES(2,100,'Sales');
insert into Departments(DivisionID,DepartmentID,DepartmentName)
VALUES(2,200,'Accounting');
insert into Departments(DivisionID,DepartmentID,DepartmentName)
VALUES(2,300,'Research');
insert into Departments(DivisionID,DepartmentID,DepartmentName)
VALUES(3,100,'Administration');
commit;
insert into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,Gender,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,CurrentSalary,Commission,DivisionID,DepartmentID) 
VALUES(2,'Fuller','Andrew','Vice President, Sales','Dr.','M','02/19/1952','08/14/1992','908 W. Capital Way','Tacoma','WA','98401','USA','(206) 555-9482','3457',NULL,9000,NULL,1,100)
/
insert into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,Gender,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,CurrentSalary,Commission,DivisionID,DepartmentID) 
VALUES(5,'Buchanan','Steven','Sales Manager','Mr.','M','03/04/1955','10/17/1993','14 Garrett Hill','London',NULL,'SW1 8JR','UK','(71) 555-4848','3453',2,5000,NULL,1,200)
/
insert into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,Gender,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,CurrentSalary,Commission,DivisionID,DepartmentID)
VALUES(1,'Davolio','Nancy','Sales Representative','Ms.','F','12/08/1948','05/01/1992','507 - 20th Ave. E. Apt. 2A','Seattle','WA','98122','USA','(206) 555-9857','5467',2,2000,NULL,1,100)
/

insert into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,Gender,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,CurrentSalary,Commission,DivisionID,DepartmentID) 
VALUES(3,'Leverling','Janet','Sales Representative','Ms.','F','08/30/1963','04/01/1992','722 Moss Bay Blvd.','Kirkland','WA','98033','USA','(206) 555-3412','3355',2,6000,NULL,1,200)
/
insert into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,Gender,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,CurrentSalary,Commission,DivisionID,DepartmentID) 
VALUES(4,'Peacock','Margaret','Sales Representative','Mrs.','F','09/19/1937','05/03/1993','4110 Old Redmond Rd.','Redmond','WA','98052','USA','(206) 555-8122','5176',2,3000,NULL,2,200)
/

insert into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,Gender,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,CurrentSalary,Commission,DivisionID,DepartmentID) 
VALUES(6,'Suyama','Michael','Sales Representative','Mr.','M','07/02/1963','10/17/1993','Coventry House Miner Rd.','London',NULL,'EC2 7JR','UK','(71) 555-7773','428',5,3600,200,2,300)
/
insert into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,Gender,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,CurrentSalary,Commission,DivisionID,DepartmentID) 
VALUES(7,'King','Robert','Sales Representative','Mr.','M','05/29/1960','01/02/1994','Edgeham Hollow Winchester Way','London',NULL,'RG1 9SP','UK','(71) 555-5598','465',5,3000,400,2,300);

insert into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,Gender,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,CurrentSalary,Commission,DivisionID,DepartmentID) 
VALUES(8,'Callahan','Laura','Inside Sales Coordinator','Ms.','F','01/09/1958','03/05/1994','4726 - 11th Ave. N.E.','Seattle','WA','98105','USA','(206) 555-1189','2344',2,4000,NULL,2,300)
/
insert into Employees(EmployeeID,LastName,FirstName,Title,TitleOfCourtesy,Gender,BirthDate,HireDate,Address,City,Region,PostalCode,Country,HomePhone,Extension,ReportsTo,CurrentSalary,Commission,DivisionID,DepartmentID) 
VALUES(9,'Dodsworth','Anne','Sales Representative','Ms.','F','01/27/1966','11/15/1994','7 Houndstooth Rd.','London',NULL,'WG2 7LT','UK','(71) 555-4444','452',5,5200,300,2,300)
/
commit;
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(1,'05/01/1992',1000,'12/31/1992')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(1,'01/01/1993',1200,'12/31/1993')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(1,'01/01/1994',1400,'12/31/1994')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(1,'01/01/1995',1800,'12/31/1995')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(1,'01/01/1996',2000,NULL)
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(2,'08/14/1992',6000,'12/31/1993')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(2,'01/01/1994',7000,'12/31/1995')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(2,'01/01/1996',8000,'12/31/1999')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(2,'01/01/2000',9000,NULL)
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(3,'04/01/1992',1000,'12/31/1992')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(3,'01/01/1993',2000,'06/30/1993')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(3,'07/01/1993',3000,'12/31/1994')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(3,'01/01/1995',4000,'12/31/1996')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(3,'01/01/1997',5000,'12/31/1998')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(3,'01/01/1999',6000,NULL)
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(4,'05/03/1993',2000,'12/31/1993')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(4,'01/01/1994',2100,'12/31/1994')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(4,'01/01/1995',2400,'12/31/1995')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(4,'01/01/1996',2600,'12/31/1996')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(4,'01/01/1997',2700,'12/31/1998')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(4,'01/01/1999',3000,NULL)
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(5,'10/17/1993',4000,'12/31/1996')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(5,'01/01/1997',5000,NULL)
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(6,'10/17/1993',2000,'12/31/1996')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(6,'01/01/1997',3600,NULL)
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(7,'01/02/1994',2500,'12/31/1996')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(7,'01/01/1997',3000,NULL)
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(8,'03/05/1994',4000,'12/31/1995')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(8,'01/01/1996',5000,'12/31/1997')
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(8,'01/01/1998',4000,NULL)
/
insert into SalaryHistories(EmployeeID,StartDate, Salary,EndDate)
VALUES(9,'11/15/1994',5200,NULL)
/
...
/
insert into Suppliers(SupplierID,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Fax,HomePage) VALUES(28,'Escargots Nouveaux','Eliane Noz','Sales Representative','Bat. B 3, rue des Alpes','Annecy',NULL,'74000','France','38.76.98.06','38.76.98.58',NULL)
/
...
/
insert into Suppliers(SupplierID,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Fax,HomePage) VALUES(30,'Junkfood','John Smith','Sales Manager','79 Regent St.','London',NULL,'WC1 6AB','UK','(171) 555-1234',NULL,NULL)
/
...
insert into Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(67,'Laughing Lumberjack 4.5% Lager',16,1,'24 - 12 oz bottles',14,52,0,10,0);
...
insert into Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(75,'Rhönbräu Klosterbier 7%',12,1,'24 - 0.5 l bottles',7.75,125,0,25,0);
...
insert into Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(78,'Lutefisk',NULL,8,'6 pieces',19.75,0,0,0,0);
...
/
GRANT SELECT ON EMPSTATISTICS TO PUBLIC
/
