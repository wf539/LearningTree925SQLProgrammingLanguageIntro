...
DROP DATABASE eastwind;
DROP USER student;
CREATE USER student WITH PASSWORD 'student';

CREATE DATABASE eastwind WITH OWNER student;
...
select count(*) AS SalaryHistories from  SalaryHistories;
...
select count(*) AS EmpStatistics   from  EmpStatistics;
